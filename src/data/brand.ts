...
// guide is the identity system — DNA, not claims. Fields registered here stay
...
export const ratificationLedger = [
  ...
  { date: '2026-07-08', decision: 'Claims posture (web, reaffirmed 2026-07-16; absorbed into canon 2026-07-19; controls named 2026-08-13): pre-launch capability copy speaks the full product vision in present tense — anchored to the ratified vision, not shipped code, and gated by two standing controls: the roadmap check at meta.sourceOfTruth before any buyer-facing capability claim, and the counsel trigger at trustCopy.counselNote before trust, security, or compliance claims reach a public page. Within those gates: no shipped-only scoping, no "soon" hedging. Compliance stays a program, not a badge: attestations and uptime/incident commitments remain staged targets, stated as such.' },
