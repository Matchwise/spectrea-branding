...
export const meta = {
  ...
  renderDoctrine:
    'Anything in canon must render somewhere in the guide (ratified 2026-08-06). A canonical field with no rendering surface is a propagation defect: agents must never receive a stricter or newer brand than people. Carve-out (ratified 2026-08-13): fields registered in internalCanon render only to the internal-tier artefacts (internal/, git-ignored, handed off locally to the private consumer repos) — the public guide carries the identity system; claim-bearing and strategy content is deliberately absent from the public site, guide, PDF, contract, and llms.txt.',
