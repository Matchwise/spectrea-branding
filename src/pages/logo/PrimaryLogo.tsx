...
export default function PrimaryLogo() {
  return (
    ...
    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 rounded-lg px-4 py-3 border border-stone-100">
                ...
                <p className="text-sm text-stone-700">2 dots left visually unconnected — the "about to connect" moment. This is the core visual metaphor: the process is never finished.</p>
              </div>
              <div className="bg-stone-50 rounded-lg px-4 py-3 border border-stone-100">
                <p className="text-xs font-semibold text-stone-500 mb-1">Container</p>
                <p className="text-sm text-stone-700">64 × 64 viewBox. Circle container when needed at small sizes. Always round, never squircle — dots are round, so the container is round.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Animated */}
      <Section>
        <h2 className="text-xl font-semibold text-stone-800 mb-4">Animated Version</h2>
        <p className="text-sm text-stone-600 mb-4">The spectrum stroke draws along the S connecting the dots, pauses, then dissolves to reveal them again. 3-second loop. Use for loading states, hero animations, and motion assets.</p>
