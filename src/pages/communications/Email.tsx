    ...
    >
      ...
      <Section>
        ...
        <div className="border border-stone-200 rounded-xl p-6">
          ...
          <div className="mt-4 bg-cloud rounded-lg px-4 py-3 border border-stone-100">
      ...
      <Section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Marketing */}
          <div>
            <p className="text-xs font-semibold text-pewter uppercase tracking-wider mb-2">Marketing / Newsletter</p>
            <div className="border border-stone-200 rounded-xl overflow-hidden">
